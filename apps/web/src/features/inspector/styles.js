...
export const s = {
  ...
  sidebar: { position: 'relative', zIndex: 1, width: '300px', flexShrink: 0, background: c.low, borderRight: `1px solid ${c.borderSoft}`, display: 'flex', flexDirection: 'column', overflow: 'hidden' },
  sidebarTabMeta: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px 10px', flexShrink: 0 },
  sidebarTabTitle: { fontFamily: c.mono, fontSize: '10px', fontWeight: 600, color: c.faint, letterSpacing: '0.22em', textTransform: 'uppercase' },
  sidebarTabHint: { fontFamily: c.mono, fontSize: '9px', color: c.faint, letterSpacing: '0.12em', textTransform: 'uppercase' },
  sidebarScroll: { flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', minHeight: 0 },

  logo: { padding: '0', flexShrink: 0 },
  logoText: { fontFamily: c.sans, fontSize: '28px', fontWeight: 500, letterSpacing: '-1px', color: c.fg, textDecoration: 'none' },
  ctxRow: { display: 'flex', alignItems: 'center', gap: '10px', margin: '0 12px 10px', padding: '8px 10px', borderRadius: '8px', flexShrink: 0 },
  ctxIcon: { fontSize: '16px', color: c.faint, flexShrink: 0 },
  ctxName: { flex: 1, fontFamily: c.sans, fontSize: '13px', color: c.dim, minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },

  urlCard: { display: 'flex', alignItems: 'center', margin: '0 12px 10px', border: `1px solid ${c.border}`, borderRadius: '6px', overflow: 'hidden', background: c.bg, flexShrink: 0 },
  urlText: { flex: 1, fontFamily: c.mono, fontSize: '11px', color: c.dim, padding: '7px 10px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', minWidth: 0 },
  copyBtn: { display: 'flex', alignItems: 'center', justifyContent: 'center', background: c.ctr, border: 'none', borderLeft: `1px solid ${c.border}`, color: c.dim, padding: '7px 10px', cursor: 'pointer', flexShrink: 0 },
